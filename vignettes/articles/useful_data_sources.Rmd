...
getwd()
pop <- read.csv("../../inst/extdata/WPP2024_Population1JanuaryBySingleAgeSex_Medium_1950-2023_IND_NGA.csv",
                stringsAsFactors = FALSE, na.strings = "<NA>",
                encoding = "UTF-8")

## only keep relevant columns, and convert to the popim_pop format:
