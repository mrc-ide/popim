...
pop <- read.csv("inst/extdata/hide/WPP2022_Population1JanuaryBySingleAgeSex_Medium_1950-2021.csv", stringsAsFactors = FALSE, na.strings = "<NA>")
pop2 <- read.csv("inst/extdata/hide/WPP2022_Population1JanuaryBySingleAgeSex_Medium_2022-2100.csv", stringsAsFactors = FALSE, na.strings = "<NA>")
